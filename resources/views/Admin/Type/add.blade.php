...
@section('container')
	<div class="block block-themed">
                                ...
                                <div class="block-content">
                                    <form class="form-horizontal push-5-t" action="{{url('Admin/Type/insert')}}" method="post" onsubmit="return true;">
                                        {{csrf_field()}}
                                        <div class="form-group">
                                            <label class="col-xs-8" for="login1-username">Username</label>
                                            <div class="col-xs-8">
                                                <input class="form-control" type="text" id="login1-username" name="name" placeholder="添加分类名字">
                                            </div>
                                        </div>
                                        <div class="form-group">
